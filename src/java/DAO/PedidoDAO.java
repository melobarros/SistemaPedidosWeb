...
public class PedidoDAO {
    ...
    /*
    SELECT produto.descricao, item_do_pedido.quantidade from produto nner join item_do_pedido on produto.id = item_do_pedido.id_produto inner join pedido on item_do_pedido.id_pedido = pedido.id where pedido.id_cliente = ?;
    */
